...
typedef NS_ENUM(NSInteger, TitleAlignmentStyle) {

    TitleAlignmentStyleCenter, //title中心位置显示--中间显示
    TitleAlignmentStyleAverage  //title平均显示
};
...
/** 添加 **标题显示的位置 */
@property (assign, nonatomic) TitleAlignmentStyle titleAlignmentStyle;
